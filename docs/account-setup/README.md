...
- [ ] **YOU still TODO:** click the "verify your account contact" email AWS sent to `<your-aws-account-email>`. Account works without it, but verification is required to close cleanly.
...
`<your-aws-account-email>`. Click through it before continuing. The
